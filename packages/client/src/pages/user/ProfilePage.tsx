    ...
    return (
        <div className="max-w-5xl w-full mx-auto my-3 p-4 grid sm:grid-cols-8 gap-6 rounded-xl">
            <div className="col-span-4 md:col-span-3 w-full">
                <Card className="flex flex-row lg:flex-col px-3 items-center">
                    <img
                        src={profile?.image}
                    ...
                    <TabsContent value="account" className="space-y-3">
                        <Card>
                            ...
                            <CardContent className="grid md:grid-cols-2 gap-2">
                                <div>
                                    <p>UserId:</p>
                                    <p className="bg-blue-100 px-3 py-2 rounded whitespace-nowrap overflow-hidden text-ellipsis">{profile?._id}</p>
                                </div>
                                <div>
                                    <p>Name:</p>
                                    <p className="bg-blue-100 px-3 py-2 rounded whitespace-nowrap overflow-hidden text-ellipsis">{profile?.name}</p>
                                </div>
                                <div>
                                    <p>Username:</p>
                                    <p className="bg-blue-100 px-3 py-2 rounded whitespace-nowrap overflow-hidden text-ellipsis">{profile?.username}</p>
                                </div>
                                <div>
                                    <p>Email:</p>
                                    <p className="bg-blue-100 px-3 py-2 rounded whitespace-nowrap overflow-hidden text-ellipsis">{profile?.email}</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Form {...form}>
